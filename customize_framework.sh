...
#then
    ...
    #sed -i "s#Lcom/android/internal/policy/impl/PhoneWindowManager;#Lcom/android/internal/policy/impl/PhoneWindowManagerEx;#g" $BUILD_OUT/android.policy/smali/com/android/internal/policy/impl/BaseMiuiPhoneWindowManager\$ScreenKeyLongPressRunnable.smali
    #sed -i "s#Lcom/android/internal/policy/impl/PhoneWindowManager;#Lcom/android/internal/policy/impl/PhoneWindowManagerEx;#g" $BUILD_OUT/android.policy/smali/com/android/internal/policy/impl/BaseMiuiPhoneWindowManager.smali
#fi
