...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/LightsService;)V
    ...
    .line 782
    iput-boolean v2, p0, Lcom/android/server/BatteryService;->ignoreNativeCall:Z

    .line 783
    iput v2, p0, Lcom/android/server/BatteryService;->mNewBatteryStatus:I

    .line 784
    iput v2, p0, Lcom/android/server/BatteryService;->mNewBatteryHealth:I

    .line 785
    iput-boolean v2, p0, Lcom/android/server/BatteryService;->mNewBatteryPresent:Z

    .line 786
    iput v2, p0, Lcom/android/server/BatteryService;->mNewBatteryLevel:I

    .line 787
    iput v2, p0, Lcom/android/server/BatteryService;->mNewBatteryVoltage:I

    .line 788
    iput v2, p0, Lcom/android/server/BatteryService;->mNewBatteryTemperature:I

    .line 789
    const-string v1, ""

    iput-object v1, p0, Lcom/android/server/BatteryService;->mNewBatteryTechnology:Ljava/lang/String;
...
.method private processValuesLocked()V
    ...
    .line 362
    :goto_2
    sget-boolean v0, Lcom/lge/config/ConfigBuildFlags;->CAPP_LGSYSTEMUI:Z
...
.method private update(Landroid/os/BatteryProperties;)V
    ...
    iget v2, p0, Lcom/android/server/BatteryService;->mNewBatteryStatus:I

    iput v2, v0, Landroid/os/BatteryProperties;->batteryStatus:I

    .line 292
    iget-object v0, p0, Lcom/android/server/BatteryService;->mBatteryProps:Landroid/os/BatteryProperties;

    iget v2, p0, Lcom/android/server/BatteryService;->mNewBatteryHealth:I

    iput v2, v0, Landroid/os/BatteryProperties;->batteryHealth:I

    .line 293
    iget-object v0, p0, Lcom/android/server/BatteryService;->mBatteryProps:Landroid/os/BatteryProperties;

    iget-boolean v2, p0, Lcom/android/server/BatteryService;->mNewBatteryPresent:Z

    iput-boolean v2, v0, Landroid/os/BatteryProperties;->batteryPresent:Z

    .line 294
    iget-object v0, p0, Lcom/android/server/BatteryService;->mBatteryProps:Landroid/os/BatteryProperties;

    iget v2, p0, Lcom/android/server/BatteryService;->mNewBatteryLevel:I
    ...
    iget v2, p0, Lcom/android/server/BatteryService;->mNewBatteryVoltage:I

    iput v2, v0, Landroid/os/BatteryProperties;->batteryVoltage:I

    .line 296
    iget-object v0, p0, Lcom/android/server/BatteryService;->mBatteryProps:Landroid/os/BatteryProperties;

    iget v2, p0, Lcom/android/server/BatteryService;->mNewBatteryTemperature:I

    iput v2, v0, Landroid/os/BatteryProperties;->batteryTemperature:I

    .line 297
    iget-object v0, p0, Lcom/android/server/BatteryService;->mBatteryProps:Landroid/os/BatteryProperties;

    iget-object v2, p0, Lcom/android/server/BatteryService;->mNewBatteryTechnology:Ljava/lang/String;

    iput-object v2, v0, Landroid/os/BatteryProperties;->batteryTechnology:Ljava/lang/String;
...
.method public setNativeCall(ZIIZIIILjava/lang/String;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/BatteryService;->update(Landroid/os/BatteryProperties;)V
