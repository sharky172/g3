...
.method public initAndLoop()V
    ...
    .line 154
    .local v109, factoryTestStr:Ljava/lang/String;
    const-string v7, ""
    ...
    .line 179
    .local v175, wm:Lcom/android/server/wm/WindowManagerService;
    const/16 v72, 0x0
    ...
    new-instance v176, Landroid/os/HandlerThread;
    ...
    .line 196
    .local v176, wmHandlerThread:Landroid/os/HandlerThread;
    invoke-virtual/range {v176 .. v176}, Ljava/lang/Thread;->start()V

    .line 197
    new-instance v21, Landroid/os/Handler;

    invoke-virtual/range {v176 .. v176}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;
    ...
    .line 228
    .local v116, lgPower:Lcom/android/server/power/PowerManagerService;
    :try_start_2
    ...
    .end local v116           #lgPower:Lcom/android/server/power/PowerManagerService;
    check-cast v116, Lcom/android/server/power/PowerManagerService;
    :try_end_2
    ...
    .restart local v116       #lgPower:Lcom/android/server/power/PowerManagerService;
    :cond_1
    :goto_3
    if-nez v116, :cond_36

    :try_start_3
    new-instance v116, Lcom/android/server/power/PowerManagerService;

    .end local v116           #lgPower:Lcom/android/server/power/PowerManagerService;
    invoke-direct/range {v116 .. v116}, Lcom/android/server/power/PowerManagerService;-><init>()V
    ...
    .line 249
    invoke-static/range {v108 .. v108}, Lcom/android/server/am/ActivityManagerService;->main(I)Landroid/content/Context;
    :try_end_3
    ...
    .line 394
    invoke-virtual/range {v175 .. v175}, Lcom/android/server/wm/WindowManagerService;->getInputMonitor()Lcom/android/server/wm/InputMonitor;
    ...
    :goto_10
    :try_start_17
    invoke-virtual/range {v175 .. v175}, Lcom/android/server/wm/WindowManagerService;->displayReady()V
    :try_end_17
    ...
    .line 611
    new-instance v174, Landroid/net/wifi/p2p/WifiP2pService;
    ...
    .line 619
    new-instance v172, Lcom/android/server/wifi/WifiService;
    ...
    .line 658
    invoke-virtual/range {v171 .. v171}, Lcom/android/server/wifi/WifiService;->checkAndStartWifi()V

    .line 660
    :cond_11
    invoke-virtual/range {v173 .. v173}, Landroid/net/wifi/p2p/WifiP2pService;->connectivityServiceReady()V
    :try_end_31
    ...
    .line 714
    .local v124, mNotificationManagerServiceEx:Lcom/android/server/NotificationManagerService;
    :try_start_37
    ...
    .end local v124           #mNotificationManagerServiceEx:Lcom/android/server/NotificationManagerService;
    check-cast v124, Lcom/android/server/NotificationManagerService;
    :try_end_37
    ...
    .end local v74           #c:Ljava/lang/Class;
    .end local v81           #constructor:Ljava/lang/reflect/Constructor;
    .restart local v124       #mNotificationManagerServiceEx:Lcom/android/server/NotificationManagerService;
    :cond_17
    :goto_29
    if-nez v124, :cond_42
    ...
    .line 773
    new-instance v168, Lcom/vzw/location/server/VzwLocationManagerService;
    ...
    .local v168, vzw_location:Lcom/vzw/location/server/VzwLocationManagerService;
    :try_start_3f
    ...
    .line 780
    .end local v168           #vzw_location:Lcom/vzw/location/server/VzwLocationManagerService;
    ...
    .line 807
    .local v125, mWallpaperManagerServiceEx:Lcom/android/server/WallpaperManagerService;
    :try_start_43
    ...
    .end local v125           #mWallpaperManagerServiceEx:Lcom/android/server/WallpaperManagerService;
    check-cast v125, Lcom/android/server/WallpaperManagerService;
    :try_end_43
    ...
    .end local v74           #c:Ljava/lang/Class;
    .end local v81           #constructor:Ljava/lang/reflect/Constructor;
    .restart local v125       #mWallpaperManagerServiceEx:Lcom/android/server/WallpaperManagerService;
    :cond_1b
    :goto_32
    if-nez v125, :cond_43

    :try_start_44
    new-instance v125, Lcom/android/server/WallpaperManagerService;
    ...
    .line 834
    .local v122, mAudioService:Landroid/media/AudioService;
    const/16 v123, 0x0

    .line 836
    .local v123, mAudioServiceEx:Landroid/media/AudioService;
    :try_start_46
    ...
    .end local v123           #mAudioServiceEx:Landroid/media/AudioService;
    check-cast v123, Landroid/media/AudioService;
    :try_end_46
    ...
    .end local v74           #c:Ljava/lang/Class;
    .end local v81           #constructor:Ljava/lang/reflect/Constructor;
    .restart local v123       #mAudioServiceEx:Landroid/media/AudioService;
    :cond_1d
    :goto_35
    if-nez v123, :cond_44

    :try_start_47
    new-instance v122, Landroid/media/AudioService;

    .end local v122           #mAudioService:Landroid/media/AudioService;
    move-object/from16 v0, v122

    invoke-direct {v0, v5}, Landroid/media/AudioService;-><init>(Landroid/content/Context;)V

    .line 849
    .restart local v122       #mAudioService:Landroid/media/AudioService;
    :goto_36
    ...
    :cond_2c
    :goto_4e
    invoke-virtual/range {v175 .. v175}, Lcom/android/server/wm/WindowManagerService;->detectSafeMode()Z
    ...
    :goto_53
    :try_start_6a
    invoke-virtual/range {v175 .. v175}, Lcom/android/server/wm/WindowManagerService;->systemReady()V
    :try_end_6a
    ...
    .line 1137
    :cond_30
    invoke-virtual/range {v175 .. v175}, Lcom/android/server/wm/WindowManagerService;->computeNewConfiguration()Landroid/content/res/Configuration;
    ...
    .end local v85           #countryDetector:Lcom/android/server/CountryDetectorService;
    .end local v89           #deviceManager:Lcom/android/server/DeviceManager3LMService;
    .end local v90           #devicePolicy:Lcom/android/server/DevicePolicyManagerService;
    .end local v92           #disableAtlas:Z
    ...
    .end local v102           #dock:Lcom/android/server/DockObserver;
    .end local v104           #dreamy:Lcom/android/server/dreams/DreamManagerService;
    .end local v108           #factoryTest:I
    .end local v109           #factoryTestStr:Ljava/lang/String;
    ...
    .end local v171           #wifi:Lcom/android/server/wifi/WifiService;
    .end local v173           #wifiP2p:Landroid/net/wifi/p2p/WifiP2pService;
    .end local v175           #wm:Lcom/android/server/wm/WindowManagerService;
    .end local v176           #wmHandlerThread:Landroid/os/HandlerThread;
    :cond_33
    const/16 v146, 0x0
    ...
    .end local v145           #reason:Ljava/lang/String;
    .end local v146           #reboot:Z
    .restart local v109       #factoryTestStr:Ljava/lang/String;
    :cond_35
    ...
    .restart local v89       #deviceManager:Lcom/android/server/DeviceManager3LMService;
    .restart local v101       #display:Lcom/android/server/display/DisplayManagerService;
    .restart local v102       #dock:Lcom/android/server/DockObserver;
    .restart local v108       #factoryTest:I
    ...
    .restart local v171       #wifi:Lcom/android/server/wifi/WifiService;
    .restart local v173       #wifiP2p:Landroid/net/wifi/p2p/WifiP2pService;
    .restart local v175       #wm:Lcom/android/server/wm/WindowManagerService;
    .restart local v176       #wmHandlerThread:Landroid/os/HandlerThread;
    :catch_0
    move-exception v106
    ...
    .restart local v92       #disableAtlas:Z
    ...
    .line 632
    .end local v106           #e:Ljava/lang/Throwable;
    .restart local v107       #enableCne:I
    :cond_40
    const/16 v75, 0x0
    ...
    .line 775
    .end local v167           #vzw_location:Lcom/vzw/location/server/VzwLocationManagerService;
    .restart local v168       #vzw_location:Lcom/vzw/location/server/VzwLocationManagerService;
    :catch_4f
    move-exception v106
