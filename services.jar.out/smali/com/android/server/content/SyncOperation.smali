...
.field private static final IS_SPR:Z = false
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/content/SyncOperation;->IS_SPR:Z
...
.method public dump(Landroid/content/pm/PackageManager;Z)Ljava/lang/String;
    ...
    sget-boolean v2, Lcom/android/server/content/SyncOperation;->IS_SPR:Z
    ...
    iget v3, p0, Lcom/android/server/content/SyncOperation;->userId:I
    ...
    iget-object v3, p0, Lcom/android/server/content/SyncOperation;->account:Landroid/accounts/Account;
    ...
    iget-object v3, p0, Lcom/android/server/content/SyncOperation;->authority:Ljava/lang/String;
    ...
    const-string v3, ", latestRunTime "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-wide v3, p0, Lcom/android/server/content/SyncOperation;->latestRunTime:J
    ...
    iget-boolean v2, p0, Lcom/android/server/content/SyncOperation;->expedited:Z
    ...
    invoke-static {v2, v1}, Lcom/android/server/content/SyncOperation;->extrasToStringBuilder(Landroid/os/Bundle;Ljava/lang/StringBuilder;)V
