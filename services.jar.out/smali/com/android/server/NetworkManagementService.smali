...
.method static synthetic access$1300(Lcom/android/server/NetworkManagementService;Ljava/lang/String;I)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$1400(Lcom/android/server/NetworkManagementService;Ljava/lang/String;I)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$1500(Lcom/android/server/NetworkManagementService;Ljava/lang/String;I)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method private modifyNat(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v11, "get interface by name error: "
    ...
    .line 1305
    .restart local v6       #interfaceAddresses:Ljava/util/Collection;,"Ljava/util/Collection<Ljava/net/InterfaceAddress;>;"
    iget-object v9, p0, Lcom/android/server/NetworkManagementService;->mTetheringIALock:Ljava/lang/Object;
...
.method private modifyRoute(Ljava/lang/String;Ljava/lang/String;Landroid/net/RouteInfo;Ljava/lang/String;)V
    ...
    iget-boolean v3, v3, Lcom/android/internal/telephony/lgdata/LgDataFeature;->LGP_DATA_DAEMON_NETD_BUGFIX_ILLEGALSTATE_EXCEPTION:Z
    ...
    const-string v5, " is already down, so modifyRoute is faild. error = "
...
.method public getNetworkStatsTethering()Landroid/net/NetworkStats;
    ...
    const-string v12, "NetworkManagementService"

    const-string v13, "[LGE_DATA] ifaceIn %s"
    ...
    const-string v13, "[LGE_DATA] ifaceOut %s"
    ...
    sget-object v12, Lcom/android/server/NetworkManagementService;->mTetherIface:Ljava/lang/String;

    if-eqz v12, :cond_1

    sget-object v8, Lcom/android/server/NetworkManagementService;->mTetherIface:Ljava/lang/String;

    const-string v12, "NetworkManagementService"

    const-string v13, "[LGE_DATA] Changed ifaceOut %s"
...
.method public runClearNatRule()V
    ...
    const-string v3, "runClearNatRule"
    ...
    const-string v3, "Error communicating with native daemon to runClearNatRule interface "
...
.method public runClearPortFilterRule()V
    ...
    const-string v3, "runClearPortFilterRule"
    ...
    const-string v4, "clearPortFilterRule"
    ...
    const-string v3, "Error communicating with native daemon to runClearPortFilterRule interface "
...
.method public runClearPortForwardRule()V
    ...
    const-string v3, "runClearPortForwardRule"
    ...
    const-string v3, "Error communicating with native daemon to runClearPortForwardRule interface "
...
.method public runSetNatForwardRule(Ljava/lang/String;)V
    ...
    const-string v5, "setNatForwardRule"
    ...
    const-string v2, "Error communicating with native daemon to runSetNatForwardRule interface "
...
.method public runSetPortFilterRule(Ljava/lang/String;I)V
    ...
    const-string v6, "runSetPortFilterRule %s %d"
    ...
    .local v4, intergetobj:Ljava/lang/Integer;
    ...
    const-string v7, "setPortFilterRule"
    ...
    invoke-direct {v2, v5, v6}, Lcom/android/server/NativeDaemonConnector$Command;-><init>(Ljava/lang/String;[Ljava/lang/Object;)V

    .local v2, cmd:Lcom/android/server/NativeDaemonConnector$Command;
    :try_start_0
    iget-object v5, p0, Lcom/android/server/NetworkManagementService;->mConnector:Lcom/android/server/NativeDaemonConnector;

    invoke-virtual {v5, v2}, Lcom/android/server/NativeDaemonConnector;->execute(Lcom/android/server/NativeDaemonConnector$Command;)Lcom/android/server/NativeDaemonEvent;
    :try_end_0
    .catch Lcom/android/server/NativeDaemonConnectorException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v6, "Error communicating with native daemon to runSetPortFilterRule interface "
...
.method public runSetPortForwardRule(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    .local v3, intergetobj:Ljava/lang/Integer;
    ...
    const-string v7, "setPortForwardRule"
    ...
    invoke-direct {v1, v4, v5}, Lcom/android/server/NativeDaemonConnector$Command;-><init>(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string v5, "Error communicating with native daemon to runSetPortForwardRule interface "
...
.method public runSetPortRedirectRule(Ljava/lang/String;I)V
    ...
    const-string v3, "[NFS] runSetPortRedirectRule"
    ...
    const-string v3, "[NFS] call docommand runSetPortRedirectRule"
    ...
    const-string v4, "[NFS] nat , setPortRedirectRule "
    ...
    const-string v6, "setPortRedirectRule"
    ...
    const-string v3, "[NFS] NativeDaemonConnectorException "
    ...
    const-string v3, "Error communicating with native daemon to runSetPortRedirectRule interface "
...
.method public setAccessPoint(Landroid/net/wifi/WifiConfiguration;Ljava/lang/String;)V
    ...
    iget-object v9, v0, Lcom/android/server/NetworkManagementService;->mContext:Landroid/content/Context;
    ...
    iget-object v9, v0, Lcom/android/server/NetworkManagementService;->mConnector:Lcom/android/server/NativeDaemonConnector;

    const-string v10, "softap"
    ...
    const-string v10, "wifi_ap_broadcast_channel"
    ...
    const-string v10, "wifi_ap_select_channel"
    ...
    const-string v10, "wifi_ap_broadcast_channel_five"
    ...
    const-string v11, "[setAccessPoint] 5G Band Selected, Channel Number is "
    ...
    .end local v1           #default5Gchannel:I
    :goto_1
    const-string v9, "true"

    const-string v10, "wlan.lge.softapwps"
    ...
    const-string v10, "[setAccessPoint] WPS: softap WPS set to true "
    ...
    const-string v10, "wifi_ap_current_max_client"
    ...
    .local v6, max_dev:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    const-string v10, "wifi_ssid_visibility"
    ...
    .local v8, visiblity:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    const-string v14, "wifi_ssid_visibility"
    ...
    .end local v2           #defaultChannel:I
    .end local v4           #isWpsSupported:I
    .end local v6           #max_dev:Ljava/lang/String;
    .end local v7           #selectBand:I
    .end local v8           #visiblity:Ljava/lang/String;
    :catch_0
    move-exception v3
    ...
    .restart local v2       #defaultChannel:I
    .restart local v4       #isWpsSupported:I
    .restart local v7       #selectBand:I
    :cond_1
    :try_start_1
    const-string v9, "NetworkManagementService"
    ...
    const-string v11, "[setAccessPoint] 2.4G Band Selected, Channel Number is "
    ...
    const-string v10, "[setAccessPoint] WPS: softap WPS set to false "

    invoke-static {v9, v10}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    goto/16 :goto_2

    .restart local v6       #max_dev:Ljava/lang/String;
    .restart local v8       #visiblity:Ljava/lang/String;
    :cond_3
    ...
    const-string v10, "hostapd_mac_acl"
...
.method public setDnsServersForInterface(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-boolean v7, Lcom/android/internal/telephony/lgdata/LgDataFeature;->LGP_DATA_CPA_KDDI:Z
...
.method public setIpFamilyTypeForInterface(Ljava/lang/String;ZZ)V
    ...
    invoke-virtual {v3, v6, v8}, Landroid/content/Context;->enforceCallingOrSelfPermission(Ljava/lang/String;Ljava/lang/String;)V
...
.method public setMdmIptables(Ljava/lang/String;)V
    ...
    const-string v2, "[LGE_DATA] call execute setmdmiptables"
    ...
    const-string v5, "setmdmiptables"
...
.method public setMdmIptablesFile(Ljava/lang/String;)V
    ...
    const-string v2, "[LGE_DATA] call execute setmdmiptablesfile"
    ...
    const-string v5, "setmdmiptablesfile"
...
.method public startAccessPoint(Landroid/net/wifi/WifiConfiguration;Ljava/lang/String;)V
    ...
    const-string v12, "startAccessPoint  start"
    ...
    invoke-interface {v11, v12, v13, v14, v15}, Lcom/lge/wifi/extension/IWifiSoftAP;->setNstartMonitoring(ZLandroid/net/wifi/WifiConfiguration;II)Z

    .line 2697
    :cond_1
    const-string v11, "NetworkManagementService"

    const-string v12, "startAccessPoint  end"
    ...
    invoke-virtual {v0, v1, v11}, Lcom/android/server/NetworkManagementService;->wifiFirmwareReload(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v12, "wifi_ap_broadcast_channel"
    ...
    const-string v12, "wifi_ap_select_channel"
    ...
    const-string v12, "wifi_ap_broadcast_channel_five"
    ...
    const-string v13, "[startAccessPoint] 5G Band Selected, Channel Number is "
    ...
    .end local v2           #default5Gchannel:I
    :goto_1
    const-string v11, "true"

    const-string v12, "wlan.lge.softapwps"
    ...
    const-string v12, "[startAccessPoint] WPS: softap WPS set to true "
    ...
    .local v9, max_dev:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    const-string v16, "wifi_ssid_visibility"
    ...
    new-instance v15, Lcom/android/server/NativeDaemonConnector$SensitiveArg;
    ...
    invoke-direct/range {v15 .. v16}, Lcom/android/server/NativeDaemonConnector$SensitiveArg;-><init>(Ljava/lang/Object;)V
    ...
    .end local v3           #defaultChannel:I
    .end local v5           #isWpsSupported:I
    .end local v9           #max_dev:Ljava/lang/String;
    .end local v10           #selectBand:I
    :catch_0
    move-exception v4
    ...
    .restart local v3       #defaultChannel:I
    .restart local v5       #isWpsSupported:I
    .restart local v10       #selectBand:I
    :cond_3
    :try_start_1
    const-string v11, "NetworkManagementService"
    ...
    const-string v13, "[startAccessPoint] 2.4G Band Selected, Channel Number is "
    ...
    const-string v12, "[startAccessPoint] WPS: softap WPS set to false "

    invoke-static {v11, v12}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    goto/16 :goto_2

    .restart local v9       #max_dev:Ljava/lang/String;
    :cond_5
    ...
    const-string v12, "hostapd_mac_acl"
    ...
    .local v6, mWifiServiceExt:Lcom/lge/wifi/extension/IWifiServiceExtension;
    if-eqz v6, :cond_d

    invoke-interface {v6, v8}, Lcom/lge/wifi/extension/IWifiServiceExtension;->getSoftApMaxScb(I)I

    move-result v8

    .end local v6           #mWifiServiceExt:Lcom/lge/wifi/extension/IWifiServiceExtension;
    :cond_d
    ...
    const-string v13, "  defaultChannel = "
    ...
    invoke-virtual/range {p0 .. p2}, Lcom/android/server/NetworkManagementService;->startVZWAccessPoint(Landroid/net/wifi/WifiConfiguration;Ljava/lang/String;)V
...
.method public startVZWAccessPoint(Landroid/net/wifi/WifiConfiguration;Ljava/lang/String;)V
    ...
    const-string v27, "NetworkManagementService"
    ...
    const-string v26, "android.permission.CHANGE_NETWORK_STATE"
    ...
    const-string v26, "android.permission.CHANGE_WIFI_STATE"
    ...
    .local v24, wep_key_index:I
    const/16 v22, 0x0

    .local v22, wep_key:Ljava/lang/String;
    const/16 v17, 0x0

    .local v17, presharedkey:Ljava/lang/String;
    const/4 v5, 0x0

    .local v5, basic_rates:Ljava/lang/String;
    :try_start_0
    move-object/from16 v0, p0
    ...
    const-string v26, "mhs_native_softap"
    ...
    .local v19, securitytype:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    const-string v26, "mhs_authentication"
    ...
    const-string v26, "mhs_encryption"
    ...
    .local v10, enctype:Ljava/lang/String;
    const/4 v6, 0x0
    ...
    const-string v26, "mhs_max_client"
    ...
    const-string v26, "mhs_hw_mode"

    invoke-static/range {v25 .. v26}, Landroid/provider/Settings$System;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v12

    .local v12, hw_mode:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    const-string v26, "mhs_ieee_80211n"
    ...
    .local v13, ieee_mode:I
    const/4 v14, 0x0

    .local v14, isWpsSupported:I
    const-string v25, "NetworkManagementService"

    new-instance v26, Ljava/lang/StringBuilder;

    invoke-direct/range {v26 .. v26}, Ljava/lang/StringBuilder;-><init>()V

    const-string v27, "[startVZWAccessPoint] hw_mode "
    ...
    const-string v27, "[startVZWAccessPoint] ieee_mode "
    ...
    const-string v26, "mhs_frequency"
    ...
    const-string v27, "[startVZWAccessPoint] selectBand "
    ...
    const-string v26, "wlan.lge.softapwps"
    ...
    const-string v26, "[startVZWAccessPoint] WPS: softap WPS set to true "
    ...
    const-string v26, "mhs_accept_file"
    ...
    const-string v26, "mhs_deny_file"

    invoke-static/range {v25 .. v26}, Landroid/provider/Settings$System;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v8

    .local v8, deny_mac_file:Ljava/lang/String;
    const/16 v23, 0x0

    .local v23, wep_key_default:I
    move-object/from16 v0, p0
    ...
    .end local v3           #ap_isolate:I
    .end local v7           #countrycode:Ljava/lang/String;
    .end local v8           #deny_mac_file:Ljava/lang/String;
    .end local v11           #hiddenssid:I
    .end local v12           #hw_mode:Ljava/lang/String;
    .end local v13           #ieee_mode:I
    .end local v14           #isWpsSupported:I
    .end local v15           #macaddr_acl:I
    .end local v16           #mhs_max_client:I
    .end local v20           #selectBand:I
    .end local v23           #wep_key_default:I
    :catch_0
    move-exception v9
    ...
    const-string v25, "WPA_WPA2_MIXED"
    ...
    .restart local v16       #mhs_max_client:I
    :catch_1
    move-exception v9
    ...
    .restart local v12       #hw_mode:Ljava/lang/String;
    .restart local v13       #ieee_mode:I
    .restart local v14       #isWpsSupported:I
    .restart local v20       #selectBand:I
    :cond_7
    const-string v25, "NetworkManagementService"

    const-string v26, "[startVZWAccessPoint] WPS: softap WPS set to false "
    ...
    .end local v10           #enctype:Ljava/lang/String;
    .end local v11           #hiddenssid:I
    .end local v12           #hw_mode:Ljava/lang/String;
    .end local v13           #ieee_mode:I
    .end local v14           #isWpsSupported:I
    .end local v16           #mhs_max_client:I
    .end local v18           #protocoltype:Ljava/lang/String;
    .end local v19           #securitytype:Ljava/lang/String;
    .end local v20           #selectBand:I
    ...
    .restart local v4       #authtype:Ljava/lang/String;
    .restart local v6       #channel:I
    .restart local v10       #enctype:Ljava/lang/String;
    .restart local v11       #hiddenssid:I
    .restart local v12       #hw_mode:Ljava/lang/String;
    .restart local v13       #ieee_mode:I
    .restart local v14       #isWpsSupported:I
    .restart local v16       #mhs_max_client:I
    .restart local v18       #protocoltype:Ljava/lang/String;
    .restart local v19       #securitytype:Ljava/lang/String;
    .restart local v20       #selectBand:I
    ...
    const-string v5, "10 20 55 60 90 110 120 180 240 360 480 540"
    ...
    const-string v5, "10 20 55 110 60 90 120 180 240 360 480 540"
    ...
    const-string v5, "60 90 120 180 240 360 480 540"
    ...
    const-string v5, "10 20 55 110 60 90 120 180 240 360 480 540"
    :try_end_5
    .catch Lcom/android/server/NativeDaemonConnectorException; {:try_start_5 .. :try_end_5} :catch_2
...
.method public stopAccessPoint(Ljava/lang/String;)V
    ...
    const-string v2, "mhs_native_softap"
    ...
    invoke-interface {v1, v4, v2, v5, v5}, Lcom/lge/wifi/extension/IWifiSoftAP;->setNstartMonitoring(ZLandroid/net/wifi/WifiConfiguration;II)Z
