...
.field private static final GPEVT_SUPL_TLS_FAIL:I = 0x10
...
.method public constructor <init>(Landroid/content/Context;Landroid/location/ILocationManager;Landroid/os/Looper;)V
    ...
    .line 334
    iput-boolean v9, p0, Lcom/android/server/location/GpsLocationProvider;->mGNSSPosTest:Z
    ...
    .line 359
    iput-boolean v9, p0, Lcom/android/server/location/GpsLocationProvider;->mLgDdmStarted:Z

    .line 385
    iput-boolean v9, p0, Lcom/android/server/location/GpsLocationProvider;->mCMCCTLSFail:Z
...
.method private CMCCAGPSTLSFailCheck(Ljava/lang/String;)Z
    .locals 5
    .parameter "nmea"
    ...
    const-string v4, "CMCCAGPSTLSFailCheck : NMEA : code "
...
.method static synthetic access$1700(Lcom/android/server/location/GpsLocationProvider;[B)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$1900(IDDDIIII)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$2200(II)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method private broadcastXtraSettings()V
    .locals 4
...
.method private lgddmstartNavigating()V
    ...
    .line 1214
    :cond_3
    iput-boolean v6, p0, Lcom/android/server/location/GpsLocationProvider;->mLgDdmStarted:Z
    ...
    .line 1218
    iput-boolean v2, p0, Lcom/android/server/location/GpsLocationProvider;->mLgDdmStarted:Z
...
.method private reportNmea(J)V
    ...
    .line 1691
    invoke-direct {p0, v4}, Lcom/android/server/location/GpsLocationProvider;->CMCCAGPSTLSFailCheck(Ljava/lang/String;)Z
    ...
    .line 1694
    iget-boolean v6, p0, Lcom/android/server/location/GpsLocationProvider;->mSingleShot:Z

    invoke-direct {p0, v6}, Lcom/android/server/location/GpsLocationProvider;->startNavigating(Z)V

    .line 1695
    const/4 v6, 0x1

    iput-boolean v6, p0, Lcom/android/server/location/GpsLocationProvider;->mCMCCTLSFail:Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
...
.method private reportStatus(I)V
    ...
    .end local v3           #listener:Lcom/android/server/location/GpsLocationProvider$Listener;
    :cond_4
    iget-boolean v6, p0, Lcom/android/server/location/GpsLocationProvider;->mLgDdmStarted:Z
    ...
    const-string v8, "mLgDdmStarted == true&& mNavigating == true, don\'t send intent "
...
.method private stopNavigating()V
    ...
    .line 1369
    iget-boolean v1, p0, Lcom/android/server/location/GpsLocationProvider;->mCMCCTLSFail:Z

    if-eqz v1, :cond_4

    .line 1370
    iput-boolean v3, p0, Lcom/android/server/location/GpsLocationProvider;->mCMCCTLSFail:Z
...
.method protected readXtraDownloadDate()V
    ...
    .line 2297
    const-string v5, "LGE_XTRA_DOWNLOAD_DATE"
    ...
    const-string v7, "unable to parse LGE_XTRA_DOWNLOAD_DATE: "
    ...
    const-string v6, " LG GNSS Ext lge_gps_xtra.data File does not exist"
...
.method public reportNiNotification(IIIIILjava/lang/String;Ljava/lang/String;IILjava/lang/String;)V
    ...
    const-string v9, "[GNSS]: privacyOverride: "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-boolean v9, v6, Lcom/android/internal/location/GpsNetInitiatedHandler$GpsNiNotification;->privacyOverride:Z
    ...
    const-string v9, "[GNSS]: NI_RESP:GPS OFF, notifyFlags: "
    ...
    const-string v9, ", response: GPS_NI_RESPONSE_DENY"
    ...
    invoke-direct {p0, p1, v7}, Lcom/android/server/location/GpsLocationProvider;->native_send_ni_response(II)V
...
.method public sendExtraCommand(Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    sput-wide v4, Lcom/android/server/location/GpsLocationProvider;->mXtraDownloadDate:J
    ...
    .line 1098
    :cond_4
    const-string v4, "call_xtra_setting"
    ...
    .line 1099
    invoke-direct {p0}, Lcom/android/server/location/GpsLocationProvider;->broadcastXtraSettings()V
