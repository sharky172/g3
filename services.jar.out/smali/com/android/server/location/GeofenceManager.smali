...
.method private updateFences()V
    ...
    check-cast v20, Lcom/android/server/location/GeofenceState;

    .line 259
    .local v20, state:Lcom/android/server/location/GeofenceState;
    move-object/from16 v0, p0
    ...
    .end local v20           #state:Lcom/android/server/location/GeofenceState;
    :catchall_0
    move-exception v21
    ...
    .restart local v20       #state:Lcom/android/server/location/GeofenceState;
    :cond_1
    :try_start_1
    move-object/from16 v0, v20
    ...
    const-string v24, "MDM Control GeofenceManager, state.packageName :"
    ...
    .line 302
    :cond_5
    invoke-virtual/range {v20 .. v20}, Lcom/android/server/location/GeofenceState;->getDistanceToBoundary()D

    move-result-wide v8

    .line 303
    .local v8, fenceDistance:D
    cmpg-double v21, v8, v15
    ...
    const-wide v23, 0x7fefffffffffffffL
    ...
    .line 315
    const-wide v23, 0x415b774000000000L

    const-wide v25, 0x40ed4c0000000000L
    ...
    invoke-static/range {v25 .. v28}, Ljava/lang/Math;->max(DD)D
    ...
    invoke-direct/range {v19 .. v19}, Landroid/location/LocationRequest;-><init>()V
