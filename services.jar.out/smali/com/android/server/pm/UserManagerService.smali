...
.field protected static final EPOCH_PLUS_30_YEARS:J = 0xdc46c32800L
...
# instance fields
.field protected final mBaseUserPath:Ljava/io/File;
...
.field protected final mInstallLock:Ljava/lang/Object;

.field protected mNextSerialNumber:I

.field protected final mPackagesLock:Ljava/lang/Object;

.field protected final mPm:Lcom/android/server/pm/PackageManagerService;
...
.field protected final mUserListFile:Ljava/io/File;

.field private mUserPackageMonitor:Lcom/android/internal/content/PackageMonitor;

.field protected final mUserRestrictions:Landroid/util/SparseArray;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/SparseArray",
            "<",
...
.field protected final mUsers:Landroid/util/SparseArray;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/SparseArray",
            "<",
...
.field protected final mUsersDir:Ljava/io/File;
...
.method static synthetic access$000(Lcom/android/server/pm/UserManagerService;I)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$100(Lcom/android/server/pm/UserManagerService;)Landroid/util/SparseBooleanArray;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$200(Lcom/android/server/pm/UserManagerService;Ljava/lang/String;I)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$300(Lcom/android/server/pm/UserManagerService;Ljava/lang/String;I)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method protected static final checkManageUsersPermission(Ljava/lang/String;)V
    .locals 4
    .parameter "message"
...
.method private fallbackToSingleUserLocked()V
    ...
    .line 613
    invoke-virtual {p0}, Lcom/android/server/pm/UserManagerService;->updateUserIdsLocked()V

    .line 615
    invoke-virtual {p0}, Lcom/android/server/pm/UserManagerService;->writeUserListLocked()V

    .line 616
    invoke-virtual {p0, v0}, Lcom/android/server/pm/UserManagerService;->writeUserLocked(Landroid/content/pm/UserInfo;)V
...
.method public checkRestrictionsChallenge(Ljava/lang/String;)I
    ...
    invoke-virtual {p0, v3}, Lcom/android/server/pm/UserManagerService;->writeUserLocked(Landroid/content/pm/UserInfo;)V
...
.method public createUser(Ljava/lang/String;I)Landroid/content/pm/UserInfo;
    ...
    invoke-interface {v11, v12}, Lcom/lge/cappuccino/IMdm;->getAllowMultiUser(Landroid/content/ComponentName;)Z
    ...
    .line 955
    :try_start_2
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/pm/UserManagerService;->isUserLimitReachedLocked()Z
    ...
    :cond_1
    :try_start_4
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/pm/UserManagerService;->getNextAvailableIdLocked()I
    ...
    .line 965
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/pm/UserManagerService;->writeUserListLocked()V

    .line 966
    move-object/from16 v0, p0

    invoke-virtual {v0, v9}, Lcom/android/server/pm/UserManagerService;->writeUserLocked(Landroid/content/pm/UserInfo;)V
    ...
    .line 970
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/pm/UserManagerService;->updateUserIdsLocked()V
...
.method protected getNextAvailableIdLocked()I
    .locals 3
...
.method public removeUser(I)Z
    ...
    invoke-virtual {p0, v2}, Lcom/android/server/pm/UserManagerService;->writeUserLocked(Landroid/content/pm/UserInfo;)V
...
.method public setUserName(ILjava/lang/String;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/server/pm/UserManagerService;->writeUserLocked(Landroid/content/pm/UserInfo;)V
...
.method protected updateUserIdsLocked()V
    .locals 6
...
.method public userForeground(I)V
    ...
    invoke-virtual {p0, v5}, Lcom/android/server/pm/UserManagerService;->writeUserLocked(Landroid/content/pm/UserInfo;)V
...
.method protected writeUserListLocked()V
    .locals 10
...
.method protected writeUserLocked(Landroid/content/pm/UserInfo;)V
    .locals 11
    .parameter "userInfo"
