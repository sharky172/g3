...
.method constructor <init>(Lcom/android/server/ServerThread;Landroid/content/Context;ZLcom/android/server/MountService;Lcom/android/server/BatteryService;Lcom/android/server/NetworkManagementService;Lcom/android/server/net/NetworkStatsService;Lcom/android/server/net/NetworkPolicyManagerService;Lcom/android/server/ConnectivityService;Lcom/android/server/DockObserver;Lcom/android/server/usb/UsbService;Lcom/android/server/TwilightService;Lcom/android/server/UiModeManagerService;Lcom/android/server/RecognitionManagerService;Lcom/android/server/AppWidgetService;ZLcom/android/server/WallpaperManagerService;Lcom/android/server/InputMethodManagerService;Lcom/android/server/StatusBarManagerService;Lcom/android/server/LocationManagerService;Lcom/android/server/CountryDetectorService;Lcom/vzw/location/server/VzwLocationManagerService;Lcom/android/server/NetworkTimeUpdateService;Lcom/android/server/CommonTimeManagementService;Lcom/android/server/TextServicesManagerService;Lcom/android/server/dreams/DreamManagerService;Lcom/android/server/AssetAtlasService;Lcom/android/server/input/InputManagerService;Lcom/android/server/TelephonyRegistry;Lcom/android/server/MSimTelephonyRegistry;Lcom/android/server/print/PrintManagerService;Lcom/android/server/media/MediaRouterService;)V
    ...
    iput-object v0, p0, Lcom/android/server/ServerThread$2;->val$vzw_locationF:Lcom/vzw/location/server/VzwLocationManagerService;
...
.method public run()V
    ...
    invoke-static {v1}, Lcom/android/server/ServerThread;->startLGSystemServer(Landroid/content/Context;)V
    ...
    .line 1310
    :try_start_11
    iget-object v1, p0, Lcom/android/server/ServerThread$2;->val$vzw_locationF:Lcom/vzw/location/server/VzwLocationManagerService;

    if-eqz v1, :cond_11

    iget-object v1, p0, Lcom/android/server/ServerThread$2;->val$vzw_locationF:Lcom/vzw/location/server/VzwLocationManagerService;

    invoke-virtual {v1}, Lcom/vzw/location/server/VzwLocationManagerService;->systemReady()V
    :try_end_11
