...
.method broadcastDragEndedLw()V
    ...
    invoke-interface {v2, v8}, Landroid/view/IWindow;->dispatchDragEvent(Landroid/view/DragEvent;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 321
    :goto_1
    iput-boolean v11, p0, Lcom/android/server/wm/DragState;->mDropInProgress:Z
    ...
    .line 308
    .restart local v8       #evt:Landroid/view/DragEvent;
    iget-object v0, p0, Lcom/android/server/wm/DragState;->mNotifiedWindows:Ljava/util/ArrayList;
...
.method broadcastDragStartedLw(FF)V
    ...
    iput-boolean v3, p0, Lcom/android/server/wm/DragState;->mDropInProgress:Z
...
.method dropFailAnimation(Landroid/graphics/PointF;Landroid/graphics/PointF;FFLandroid/view/SurfaceControl;Lcom/android/server/wm/WindowManagerService;)V
    ...
    invoke-direct/range {v0 .. v7}, Lcom/android/server/wm/DragState$1;-><init>(Lcom/android/server/wm/DragState;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/view/SurfaceControl;FFLcom/android/server/wm/WindowManagerService;)V
...
.method endDragLw(Lcom/android/server/wm/WindowState;)V
    ...
    iget-object v5, p0, Lcom/android/server/wm/DragState;->mSurfaceControl:Landroid/view/SurfaceControl;

    iget-object v6, p0, Lcom/android/server/wm/DragState;->mService:Lcom/android/server/wm/WindowManagerService;

    move-object v0, p0

    invoke-virtual/range {v0 .. v6}, Lcom/android/server/wm/DragState;->dropFailAnimation(Landroid/graphics/PointF;Landroid/graphics/PointF;FFLandroid/view/SurfaceControl;Lcom/android/server/wm/WindowManagerService;)V
...
.method notifyDropLw(FF)Z
    ...
    .line 479
    :cond_1
    iget-boolean v1, p0, Lcom/android/server/wm/DragState;->mDropInProgress:Z
    ...
    iput-boolean v1, p0, Lcom/android/server/wm/DragState;->mDropInProgress:Z
...
.method notifyMoveLw(FF)V
    ...
    .line 397
    .local v10, myPid:I
    iget-boolean v0, p0, Lcom/android/server/wm/DragState;->mDropInProgress:Z
