...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-virtual {v3, v0, v1, v12}, Landroid/media/AudioService;->handleDeviceConnection(ZILjava/lang/String;)Z
    ...
    invoke-static {v3}, Landroid/media/AudioService;->access$1500(Landroid/media/AudioService;)Ljava/util/ArrayList;
    ...
    invoke-static {v3, v0}, Landroid/media/AudioService;->access$1700(Landroid/media/AudioService;I)V
    ...
    invoke-static {v3, v5}, Landroid/media/AudioService;->access$1802(Landroid/media/AudioService;I)I
    ...
    invoke-static {v3, v4}, Landroid/media/AudioService;->access$2602(Landroid/media/AudioService;Z)Z
    ...
    iget-object v3, v3, Landroid/media/AudioService;->mContext:Landroid/content/Context;
    ...
    iput-object v3, v4, Landroid/media/AudioService;->mKeyguardManager:Landroid/app/KeyguardManager;
    ...
    invoke-static {v3, v4}, Landroid/media/AudioService;->access$5102(Landroid/media/AudioService;I)I
    ...
    invoke-static {v3}, Landroid/media/AudioService;->access$2200(Landroid/media/AudioService;)Z
    ...
    invoke-static {v4}, Landroid/media/AudioService;->access$5200(Landroid/media/AudioService;)Landroid/bluetooth/BluetoothProfile$ServiceListener;
    ...
    invoke-static {v3, v0}, Landroid/media/AudioService;->access$5300(Landroid/media/AudioService;Landroid/content/Context;)V
    ...
    invoke-static {v3, v4}, Landroid/media/AudioService;->access$5400(Landroid/media/AudioService;Z)V
    ...
    #getter for: Landroid/media/AudioService;->mPlugged:Z
    ...
    const-string v4, "AUX: ac_for_aux=true"

    invoke-static {v3, v4}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 4348
    const-string v3, "ac_for_aux=true"
    ...
    #setter for: Landroid/media/AudioService;->mPlugged:Z
    invoke-static {v3, v4}, Landroid/media/AudioService;->access$5502(Landroid/media/AudioService;Z)Z
    ...
    const-string v4, "AUX: ac_for_aux=false"

    invoke-static {v3, v4}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 4354
    const-string v3, "ac_for_aux=false"
