...
.method static synthetic access$2800(Landroid/media/AudioService$AudioHandler;Landroid/media/MediaPlayer;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method private onLoadSoundEffects()Z
    ...
    invoke-static {v11}, Landroid/media/AudioService;->access$900(Landroid/media/AudioService;)Ljava/lang/Object;
    ...
    invoke-static {v11}, Landroid/media/AudioService;->access$2600(Landroid/media/AudioService;)Z
    ...
    invoke-static {v11}, Landroid/media/AudioService;->access$1000(Landroid/media/AudioService;)Landroid/media/SoundPool;
    ...
    invoke-virtual {v11}, Landroid/media/AudioService;->loadTouchSoundAssets()V
    ...
    invoke-static {v11, v13}, Landroid/media/AudioService;->access$1002(Landroid/media/AudioService;Landroid/media/SoundPool;)Landroid/media/SoundPool;
    ...
    invoke-static {v11, v13}, Landroid/media/AudioService;->access$1102(Landroid/media/AudioService;Landroid/media/AudioService$SoundPoolCallback;)Landroid/media/AudioService$SoundPoolCallback;
    ...
    invoke-static {v11, v13}, Landroid/media/AudioService;->access$2702(Landroid/media/AudioService;Landroid/media/AudioService$SoundPoolListenerThread;)Landroid/media/AudioService$SoundPoolListenerThread;
    ...
    invoke-static {v11}, Landroid/media/AudioService;->access$2700(Landroid/media/AudioService;)Landroid/media/AudioService$SoundPoolListenerThread;
    ...
    invoke-static {v11}, Landroid/media/AudioService;->access$1100(Landroid/media/AudioService;)Landroid/media/AudioService$SoundPoolCallback;
    :try_end_1
    ...
    invoke-static {v11}, Landroid/media/AudioService;->access$800(Landroid/media/AudioService;)Landroid/os/Looper;
    ...
    invoke-static {v11, v13}, Landroid/media/AudioService;->access$802(Landroid/media/AudioService;Landroid/os/Looper;)Landroid/os/Looper;
    ...
    .local v4, effect:I
    :goto_3
    sget v11, Landroid/media/AudioManager;->NUM_SOUND_EFFECTS:I
    ...
    iget-object v11, v11, Landroid/media/AudioService;->SOUND_EFFECT_FILES_MAP:[[I
    ...
    iget-object v14, v14, Landroid/media/AudioService;->SOUND_EFFECT_FILES_MAP:[[I
...
.method private onPlaySoundEffect(II)V
    ...
    #getter for: Landroid/media/AudioService;->mSoundPool:Landroid/media/SoundPool;
    invoke-static {v0}, Landroid/media/AudioService;->access$1000(Landroid/media/AudioService;)Landroid/media/SoundPool;
...
.method private onUnloadSoundEffects()V
    ...
    #getter for: Landroid/media/AudioService;->mSoundEffectsLock:Ljava/lang/Object;
    invoke-static {v3}, Landroid/media/AudioService;->access$900(Landroid/media/AudioService;)Ljava/lang/Object;
    ...
    #getter for: Landroid/media/AudioService;->mSoundPool:Landroid/media/SoundPool;
    invoke-static {v3}, Landroid/media/AudioService;->access$1000(Landroid/media/AudioService;)Landroid/media/SoundPool;
    ...
    #setter for: Landroid/media/AudioService;->mSoundPool:Landroid/media/SoundPool;
    invoke-static {v3, v5}, Landroid/media/AudioService;->access$1002(Landroid/media/AudioService;Landroid/media/SoundPool;)Landroid/media/SoundPool;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {}, Landroid/media/AudioService;->access$2900()V
    ...
    invoke-static/range {v17 .. v17}, Landroid/media/AudioService$VolumeStreamState;->access$3100(Landroid/media/AudioService$VolumeStreamState;)I
    ...
    invoke-static {v1}, Landroid/media/AudioService;->access$3200(Landroid/media/AudioService;)V
    ...
    invoke-static {v1}, Landroid/media/AudioService;->access$3400(Landroid/media/AudioService;)V
    ...
    invoke-static {v1}, Landroid/media/AudioService;->access$3600(Landroid/media/AudioService;)V
    ...
    invoke-static {v1}, Landroid/media/AudioService;->access$4500(Landroid/media/AudioService;)V
