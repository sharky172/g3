...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v1, v2}, Landroid/net/CaptivePortalTracker;->access$3700(Landroid/net/CaptivePortalTracker;Ljava/lang/String;)V
    ...
    invoke-static {v2}, Landroid/net/CaptivePortalTracker;->access$3800(Landroid/net/CaptivePortalTracker;)Lcom/android/internal/util/State;

    move-result-object v2

    #calls: Landroid/net/CaptivePortalTracker;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v1, v2}, Landroid/net/CaptivePortalTracker;->access$3900(Landroid/net/CaptivePortalTracker;Lcom/android/internal/util/IState;)V
    ...
    invoke-static {v1, v0}, Landroid/net/CaptivePortalTracker;->access$3300(Landroid/net/CaptivePortalTracker;Landroid/net/NetworkInfo;)Z
    ...
    #calls: Landroid/net/CaptivePortalTracker;->log(Ljava/lang/String;)V
    invoke-static {v1, v2}, Landroid/net/CaptivePortalTracker;->access$4000(Landroid/net/CaptivePortalTracker;Ljava/lang/String;)V

    .line 390
    iget-object v1, p0, Landroid/net/CaptivePortalTracker$ActiveNetworkState;->this$0:Landroid/net/CaptivePortalTracker;

    #calls: Landroid/net/CaptivePortalTracker;->deferMessage(Landroid/os/Message;)V
    invoke-static {v1, p1}, Landroid/net/CaptivePortalTracker;->access$4100(Landroid/net/CaptivePortalTracker;Landroid/os/Message;)V
    ...
    #calls: Landroid/net/CaptivePortalTracker;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v1, v2}, Landroid/net/CaptivePortalTracker;->access$4200(Landroid/net/CaptivePortalTracker;Lcom/android/internal/util/IState;)V
