...
.method public enter()V
    ...
    invoke-static {v0}, Landroid/net/CaptivePortalTracker;->access$3100(Landroid/net/CaptivePortalTracker;)V
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v2, v3}, Landroid/net/CaptivePortalTracker;->access$3200(Landroid/net/CaptivePortalTracker;Ljava/lang/String;)V
    ...
    invoke-static {v2, v0}, Landroid/net/CaptivePortalTracker;->access$3300(Landroid/net/CaptivePortalTracker;Landroid/net/NetworkInfo;)Z
    ...
    invoke-static {v3}, Landroid/net/CaptivePortalTracker;->access$3400(Landroid/net/CaptivePortalTracker;)Lcom/android/internal/util/State;

    move-result-object v3

    #calls: Landroid/net/CaptivePortalTracker;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v2, v3}, Landroid/net/CaptivePortalTracker;->access$3500(Landroid/net/CaptivePortalTracker;Lcom/android/internal/util/IState;)V
    ...
    #calls: Landroid/net/CaptivePortalTracker;->log(Ljava/lang/String;)V
    invoke-static {v2, v3}, Landroid/net/CaptivePortalTracker;->access$3600(Landroid/net/CaptivePortalTracker;Ljava/lang/String;)V
