...
.method public enter()V
    ...
    invoke-static {v1}, Landroid/net/CaptivePortalTracker;->access$600(Landroid/net/CaptivePortalTracker;)Z
    ...
    invoke-static {}, Landroid/net/CaptivePortalTracker;->access$4400()I
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v6, v7}, Landroid/net/CaptivePortalTracker;->access$4500(Landroid/net/CaptivePortalTracker;Ljava/lang/String;)V
    ...
    invoke-static {v6}, Landroid/net/CaptivePortalTracker;->access$3100(Landroid/net/CaptivePortalTracker;)V
    ...
    invoke-static {v7}, Landroid/net/CaptivePortalTracker;->access$4600(Landroid/net/CaptivePortalTracker;)Ljava/lang/String;
    ...
    .line 426
    invoke-static {v3}, Landroid/net/CaptivePortalTracker;->access$2002(Ljava/net/InetAddress;)Ljava/net/InetAddress;
    ...
    invoke-static {v6, v3}, Landroid/net/CaptivePortalTracker;->access$4800(Landroid/net/CaptivePortalTracker;Ljava/net/InetAddress;)Z
    ...
    #calls: Landroid/net/CaptivePortalTracker;->log(Ljava/lang/String;)V
    invoke-static {v5, v6}, Landroid/net/CaptivePortalTracker;->access$4900(Landroid/net/CaptivePortalTracker;Ljava/lang/String;)V
    ...
    invoke-static {v5, v6, v0}, Landroid/net/CaptivePortalTracker;->access$5100(Landroid/net/CaptivePortalTracker;Landroid/net/NetworkInfo;Z)V
    ...
    invoke-static {v5}, Landroid/net/CaptivePortalTracker;->access$1600(Landroid/net/CaptivePortalTracker;)Landroid/net/IConnectivityManager;
    ...
    invoke-static {v9}, Landroid/net/CaptivePortalTracker;->access$5200(Landroid/net/CaptivePortalTracker;)Ljava/lang/String;
    ...
    invoke-static {v6}, Landroid/net/CaptivePortalTracker;->access$5300(Landroid/net/CaptivePortalTracker;)Lcom/android/internal/util/State;

    move-result-object v6

    #calls: Landroid/net/CaptivePortalTracker;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v5, v6}, Landroid/net/CaptivePortalTracker;->access$5400(Landroid/net/CaptivePortalTracker;Lcom/android/internal/util/IState;)V
    ...
    #calls: Landroid/net/CaptivePortalTracker;->log(Ljava/lang/String;)V
    invoke-static {v5, v6}, Landroid/net/CaptivePortalTracker;->access$5000(Landroid/net/CaptivePortalTracker;Ljava/lang/String;)V
    ...
    invoke-static {v5}, Landroid/net/CaptivePortalTracker;->access$500(Landroid/net/CaptivePortalTracker;)Landroid/content/Context;
