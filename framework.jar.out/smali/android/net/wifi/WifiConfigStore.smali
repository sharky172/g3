...
.field private static sWifiServiceExt:Lcom/lge/wifi/extension/IWifiServiceExtension;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/net/wifi/WifiConfigStore;->sWifiServiceExt:Lcom/lge/wifi/extension/IWifiServiceExtension;
...
.method private addOrUpdateNetworkNative(Landroid/net/wifi/WifiConfiguration;)Landroid/net/wifi/NetworkUpdateResult;
    ...
    .prologue
    .line 1308
    sget-boolean v24, Lcom/lge/wifi/config/LgeWifiConfig;->CONFIG_LGE_WLAN_PATCH:Z

    if-eqz v24, :cond_0

    sget-object v24, Landroid/net/wifi/WifiConfigStore;->sWifiServiceExt:Lcom/lge/wifi/extension/IWifiServiceExtension;
    ...
    invoke-interface {v0, v1}, Lcom/lge/wifi/extension/IWifiServiceExtension;->addOrUpdateNetwork(Landroid/net/wifi/WifiConfiguration;)Z
    ...
    invoke-interface {v0, v1, v2, v3}, Lcom/lge/wifi/extension/IWifiServiceExtension;->setNetworkVariableCommand(ILjava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v25, "failed to set Korean SSID: "
    ...
    .line 1407
    :cond_8
    sget-boolean v24, Lcom/lge/wifi/config/LgeWifiConfig;->CONFIG_LGE_WLAN_BRCM_PATCH:Z
    ...
    sget-boolean v24, Landroid/net/wifi/WifiConfigStore;->mLgeKtCm:Z
    ...
    :cond_1e
    sget-boolean v24, Lcom/lge/wifi/config/LgeWifiConfig;->CONFIG_LGE_WLAN_DCF:Z
    ...
    const-string v25, "captive_check"
    ...
    const-string v25, ": 2lee failed to set captiveCheck: "
    ...
    const-string v25, ": failed to set phase1"

    invoke-virtual/range {v24 .. v25}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v24

    const-string v25, ": fast_provisioning=2"
    ...
    const-string v25, ": failed to set pac_file"

    invoke-virtual/range {v24 .. v25}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v24

    const-string v25, ": /data/misc/wifi/fast-mschapv2.pac"
    ...
    iget v0, v0, Landroid/net/wifi/WifiConfigStore;->mLastPriority:I
    ...
    iput v0, v1, Landroid/net/wifi/WifiConfigStore;->mLastPriority:I
...
.method private isRemovableNetwork(I)Z
    ...
    .line 2208
    sget-object v0, Landroid/net/wifi/WifiConfigStore;->sWifiServiceExt:Lcom/lge/wifi/extension/IWifiServiceExtension;

    if-eqz v0, :cond_1

    sget-object v0, Landroid/net/wifi/WifiConfigStore;->sWifiServiceExt:Lcom/lge/wifi/extension/IWifiServiceExtension;

    invoke-interface {v0, p1}, Lcom/lge/wifi/extension/IWifiServiceExtension;->isRemovableNetwork(I)Z
...
.method private readNetworkVariables(Landroid/net/wifi/WifiConfiguration;)V
    ...
    sget-object v11, Landroid/net/wifi/WifiConfigStore;->sWifiServiceExt:Lcom/lge/wifi/extension/IWifiServiceExtension;
    ...
    invoke-interface {v11, v7, v12}, Lcom/lge/wifi/extension/IWifiServiceExtension;->getNetworkVariableCommand(ILjava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v12, "psk_key_type"
    ...
    const-string/jumbo v12, "wapi_as_cert"
    ...
    .line 2065
    :cond_20
    const-string v11, "***WAPI : not WAPI"

    invoke-direct {p0, v11}, Landroid/net/wifi/WifiConfigStore;->log(Ljava/lang/String;)V
...
.method private removeConfigAndSendBroadcastIfNeeded(I)V
    ...
    .line 607
    const-string/jumbo v1, "skip enterpriseConfig.removeKeys."

    invoke-direct {p0, v1}, Landroid/net/wifi/WifiConfigStore;->log(Ljava/lang/String;)V
...
.method disableNetwork(II)Z
    ...
    .line 704
    sget-object v3, Landroid/net/wifi/WifiConfigStore;->sWifiServiceExt:Lcom/lge/wifi/extension/IWifiServiceExtension;
    ...
    invoke-interface {v3, p1, v4}, Lcom/lge/wifi/extension/IWifiServiceExtension;->addWifiConnectionList(II)V
...
.method enableAllNetworks()V
    ...
    invoke-static {v4}, Landroid/net/wifi/Injector$WifiConfigStoreHook;->shouldEnableAllNetworks(Landroid/content/Context;)Z
    ...
    .line 262
    sget-object v4, Landroid/net/wifi/WifiConfigStore;->sWifiServiceExt:Lcom/lge/wifi/extension/IWifiServiceExtension;

    invoke-interface {v4}, Lcom/lge/wifi/extension/IWifiServiceExtension;->isFirstUserSignOnSeen()Z
    ...
    invoke-virtual {v4}, Landroid/net/wifi/WifiEnterpriseConfig;->needsSoftwareBackedKeyStore()Z
    ...
    const-string v5, "\"COSMOTEWiFiAuto\""
...
.method enableLockedKeyStoreNetworks()V
    ...
    invoke-virtual {v3}, Landroid/net/wifi/WifiEnterpriseConfig;->needsSoftwareBackedKeyStore()Z
    ...
    invoke-virtual {p0, v3, v4}, Landroid/net/wifi/WifiConfigStore;->enableNetworkWithoutBroadcast(IZ)Z
...
.method forgetNetwork(I)Z
    ...
    .line 478
    invoke-direct {p0, p1}, Landroid/net/wifi/WifiConfigStore;->isRemovableNetwork(I)Z
    ...
    .line 485
    :cond_0
    invoke-virtual {p0, p1}, Landroid/net/wifi/WifiConfigStore;->forgetNetworkForUtf8Hidden(I)Z
    ...
    .line 492
    const-string/jumbo v2, "skip to enable other disabled networks"
    ...
    invoke-virtual {v4, v5, v2}, Landroid/net/wifi/WifiNative;->enableNetwork(IZ)Z
...
.method forgetNetworkForUtf8Hidden(I)Z
    ...
    const-string/jumbo v8, "same hangul SSID, netId = "
    ...
    invoke-direct {p0, v4, v2}, Landroid/net/wifi/WifiConfigStore;->localLog(Ljava/lang/String;I)V

    .line 545
    iget-object v4, p0, Landroid/net/wifi/WifiConfigStore;->mWifiNative:Landroid/net/wifi/WifiNative;

    invoke-virtual {v4, v2}, Landroid/net/wifi/WifiNative;->removeNetwork(I)Z
    ...
    .line 546
    invoke-direct {p0, v2}, Landroid/net/wifi/WifiConfigStore;->removeConfigAndSendBroadcastIfNeeded(I)V
...
.method public getWifiConfiguration(I)Landroid/net/wifi/WifiConfiguration;
    ...
    const-string v2, "2lee getWifiConfiguration, SSID of "
...
.method public isCaptiveProfile(I)Z
    ...
    const-string v4, "2lee isCaptiveProfile, config.captiveCheck : "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget v4, v0, Landroid/net/wifi/WifiConfiguration;->captiveCheck:I
...
.method loadConfiguredNetworks()V
    ...
    .line 912
    sget-boolean v10, Lcom/lge/wifi/config/LgeWifiConfig;->CONFIG_LGE_WLAN_PATCH:Z
    ...
    .line 914
    .local v9, savedNetId:Ljava/lang/Integer;
    if-eqz v9, :cond_3
    ...
    invoke-virtual {p0, v10}, Landroid/net/wifi/WifiConfigStore;->forgetNetwork(I)Z
    ...
    .line 884
    .end local v9           #savedNetId:Ljava/lang/Integer;
    :cond_4
    :goto_3
    add-int/lit8 v2, v2, 0x1
...
.method saveNetwork(Landroid/net/wifi/WifiConfiguration;)Landroid/net/wifi/NetworkUpdateResult;
    ...
    .line 405
    invoke-virtual {p0, p1}, Landroid/net/wifi/WifiConfigStore;->saveNetworkForUtf8Hidden(Landroid/net/wifi/WifiConfiguration;)Landroid/net/wifi/NetworkUpdateResult;
...
.method saveNetworkForUtf8Hidden(Landroid/net/wifi/WifiConfiguration;)Landroid/net/wifi/NetworkUpdateResult;
    .locals 7
    .parameter "config"
    ...
    invoke-virtual {v4, v1, v5}, Landroid/net/wifi/WifiNative;->enableNetwork(IZ)Z
    ...
    const-string/jumbo v6, "saveNetworkForUtf8Hidden: enableNetwork ="
...
.method selectNetwork(I)Z
    ...
    .line 350
    const-string v5, "2lee selectNetwork set captiveCheck to 0."
