...
.method private checkPointerID(Landroid/view/MotionEvent;)Landroid/view/MotionEvent;
    ...
    invoke-virtual {v4, v6}, Ljava/util/BitSet;->previousSetBit(I)I
...
.method private setReportValue(Landroid/view/MotionEvent;Landroid/view/IEventFilter$ReturnAct;Z)Landroid/view/TouchEventFilter$DoAction;
    ...
    invoke-virtual {v6, v9}, Ljava/util/BitSet;->xor(Ljava/util/BitSet;)V
...
.method public filtering(Landroid/view/MotionEvent;)Landroid/view/MotionEvent;
    ...
    invoke-virtual {v3, v4}, Ljava/util/BitSet;->and(Ljava/util/BitSet;)V
    ...
    .line 239
    invoke-virtual/range {v23 .. v23}, Landroid/view/InputEvent;->getSequenceNumber()I

    move-result v3

    invoke-virtual/range {p1 .. p1}, Landroid/view/InputEvent;->getSequenceNumber()I
