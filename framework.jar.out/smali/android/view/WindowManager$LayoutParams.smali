...
.field public navigationBarBackgroundRes:I
...
.field public statusBarBackgroundRes:I
...
.method public constructor <init>()V
    ...
    .line 1470
    iput v3, p0, Landroid/view/WindowManager$LayoutParams;->statusBarBackgroundRes:I

    .line 1472
    iput v3, p0, Landroid/view/WindowManager$LayoutParams;->navigationBarBackgroundRes:I
...
.method public constructor <init>(III)V
    ...
    .line 1470
    iput v2, p0, Landroid/view/WindowManager$LayoutParams;->statusBarBackgroundRes:I

    .line 1472
    iput v2, p0, Landroid/view/WindowManager$LayoutParams;->navigationBarBackgroundRes:I
...
.method public constructor <init>(Landroid/os/Parcel;)V
    ...
    iput v1, p0, Landroid/view/WindowManager$LayoutParams;->statusBarBackgroundRes:I

    iput v1, p0, Landroid/view/WindowManager$LayoutParams;->navigationBarBackgroundRes:I
    ...
    iput v0, p0, Landroid/view/WindowManager$LayoutParams;->statusBarBackgroundRes:I
    ...
    iput v0, p0, Landroid/view/WindowManager$LayoutParams;->navigationBarBackgroundRes:I
...
.method public final copyFrom(Landroid/view/WindowManager$LayoutParams;)I
    ...
    .line 1771
    :cond_1d
    iget v2, p0, Landroid/view/WindowManager$LayoutParams;->statusBarBackgroundRes:I

    iget v3, p1, Landroid/view/WindowManager$LayoutParams;->statusBarBackgroundRes:I

    if-eq v2, v3, :cond_1e

    .line 1772
    iget v2, p1, Landroid/view/WindowManager$LayoutParams;->statusBarBackgroundRes:I

    iput v2, p0, Landroid/view/WindowManager$LayoutParams;->statusBarBackgroundRes:I

    .line 1775
    :cond_1e
    iget v2, p0, Landroid/view/WindowManager$LayoutParams;->navigationBarBackgroundRes:I

    iget v3, p1, Landroid/view/WindowManager$LayoutParams;->navigationBarBackgroundRes:I

    if-eq v2, v3, :cond_1f

    .line 1776
    iget v2, p1, Landroid/view/WindowManager$LayoutParams;->navigationBarBackgroundRes:I
...
.method public toString()Ljava/lang/String;
    ...
    .line 1878
    :cond_11
    iget v1, p0, Landroid/view/WindowManager$LayoutParams;->statusBarBackgroundRes:I

    if-eqz v1, :cond_12

    .line 1879
    const-string v1, " statusBarBackgroundRes="
    ...
    .line 1881
    :cond_12
    iget v1, p0, Landroid/view/WindowManager$LayoutParams;->navigationBarBackgroundRes:I

    if-eqz v1, :cond_13

    .line 1882
    const-string v1, " navigationBarBackgroundRes="
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 1560
    iget v0, p0, Landroid/view/WindowManager$LayoutParams;->statusBarBackgroundRes:I

    invoke-virtual {p1, v0}, Landroid/os/Parcel;->writeInt(I)V

    .line 1561
    iget v0, p0, Landroid/view/WindowManager$LayoutParams;->navigationBarBackgroundRes:I
