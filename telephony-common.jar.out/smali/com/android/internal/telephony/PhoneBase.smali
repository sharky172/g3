...
.field protected static final EVENT_AKA_AUTHENTICATE_DONE:I = 0x28

.field protected static final EVENT_CALL_RING:I = 0xe

.field protected static final EVENT_CALL_RING_CONTINUE:I = 0xf

.field protected static final EVENT_CANCEL_MANUAL_SEARCHING:I = 0x27

.field protected static final EVENT_CDMA_SUBSCRIPTION_SOURCE_CHANGED:I = 0x1b

.field protected static final EVENT_DEACTIVATE_APPLICATION_DONE:I = 0x2a
...
.field protected static final EVENT_GBA_AUTHENTICATE_BOOTSTRAP_DONE:I = 0x2b

.field protected static final EVENT_GBA_AUTHENTICATE_NAF_DONE:I = 0x2c
...
.field protected static final EVENT_SELECT_APPLICATION_DONE:I = 0x29
...
.field protected static final EVENT_SET_LTE_ONLY_FOR_TDD:I = 0x3b
...
.field protected static final EVENT_SET_VOLTE_E911_SCAN_LIST:I = 0x2f
...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Lcom/android/internal/telephony/PhoneBase;->mEcmExitTime:J

    .line 283
    const/4 v0, 0x0

    sput-boolean v0, Lcom/android/internal/telephony/PhoneBase;->isUSimSmsDeleted:Z
...
.method protected constructor <init>(Ljava/lang/String;Lcom/android/internal/telephony/PhoneNotifier;Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;Z)V
    ...
    iput-boolean v5, p0, Lcom/android/internal/telephony/PhoneBase;->mVmUrgent:Z

    .line 262
    const/4 v5, 0x0

    iput-boolean v5, p0, Lcom/android/internal/telephony/PhoneBase;->mIsE911ForVolte:Z
    ...
    iput-object v5, p0, Lcom/android/internal/telephony/PhoneBase;->mEmodeInfoforAndroid:[Ljava/lang/String;
    ...
    iput-object v5, p0, Lcom/android/internal/telephony/PhoneBase;->mCallModifyRegistrants:Landroid/os/RegistrantList;
    ...
    iput-object v5, p0, Lcom/android/internal/telephony/PhoneBase;->mAvpUpgradeFailureRegistrants:Landroid/os/RegistrantList;
    ...
    iput-object v5, p0, Lcom/android/internal/telephony/PhoneBase;->mReferredNetworkTypeRegistrants:Landroid/os/RegistrantList;
    ...
    const-string v6, "lgu_lte_single_device"
    ...
    invoke-static {v5, v6}, Lcom/android/internal/telephony/UPlusRILEventDispatcher;->getUPlusRILEventDispatcher(Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;)Lcom/android/internal/telephony/UPlusRILEventDispatcher;

    move-result-object v5

    iput-object v5, p0, Lcom/android/internal/telephony/PhoneBase;->mRD:Lcom/android/internal/telephony/UPlusRILEventDispatcher;
    ...
    invoke-virtual {v5}, Lcom/android/internal/telephony/SingleBinary;->updateSystemLanguage()V
    ...
    invoke-virtual {v5}, Lcom/android/internal/telephony/SingleBinary;->switchCustBaseNTCode()V
    ...
    const-string v7, "SharedPreference(mcc_change) saved mcc = "
    ...
    const-string v7, "Init SharedPreference(mcc_change) new mcc = "
    ...
    .end local v2           #savedMcc:Ljava/lang/String;
    :cond_5
    const-string v5, "KR"
    ...
    .line 493
    .local v3, savedPropertyCamped_MccMnc:Ljava/lang/String;
    const-string v5, "PhoneBase"
    ...
    const-string v7, "savedPropertyCamped_MccMnc = "
    ...
    .line 510
    .end local v3           #savedPropertyCamped_MccMnc:Ljava/lang/String;
    :cond_6
    :goto_0
    const-string v5, "KR"
    ...
    invoke-static {v5, v6}, Lcom/android/internal/telephony/LgeRoamingEventDispatcher;->getLgeRoamingEventDispatcher(Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;)Lcom/android/internal/telephony/LgeRoamingEventDispatcher;

    .line 517
    :cond_7
    invoke-static {}, Lcom/android/internal/telephony/lgdata/LgDataFeature;->getInstance()Lcom/android/internal/telephony/lgdata/LgDataFeature;

    sget-boolean v5, Lcom/android/internal/telephony/lgdata/LgDataFeature;->LGP_DATA_ROAMING_SET_ROAMING_STATUS:Z
    ...
    const-string v6, "[KDDI-DATA] LGP_DATA_ROAMING_SET_ROAMING_STATUS."
    ...
    const-string v6, "[KDDI-DATA] DATA_ROAMING is Not Enabled in Setting DB."
    ...
    invoke-interface {v5, v6, v7}, Lcom/android/internal/telephony/CommandsInterface;->setDataRoamingStatus(ZLandroid/os/Message;)V
    :try_end_0
    ...
    .line 498
    .restart local v3       #savedPropertyCamped_MccMnc:Ljava/lang/String;
    :cond_9
    const-string v5, "KR"
    ...
    const-string v6, "[KDDI-DATA] Settings.SettingNotFoundException e."
...
.method public static getEndTimeForEcm()J
    ...
    sget-wide v6, Lcom/android/internal/telephony/PhoneBase;->mEcmExitTime:J
...
.method public static setCurrentTimeForEcm(J)V
    ...
    sget-wide v2, Lcom/android/internal/telephony/PhoneBase;->mEcmExitTime:J
...
.method public dialForVolte(Ljava/lang/String;)Z
    ...
    const-string v1, "Error! dialForVolte() in PhoneBase should not be called."
...
.method public getDebugInfoValue(Landroid/os/Message;)V
    ...
    const-string v1, "PhoneBase getDebugInfoValue"
...
.method public getIsE911ForVolte()Z
    ...
    iget-boolean v2, p0, Lcom/android/internal/telephony/PhoneBase;->mIsE911ForVolte:Z
    ...
    .line 1858
    iget-boolean v0, p0, Lcom/android/internal/telephony/PhoneBase;->mIsE911ForVolte:Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v5, "Event EVENT_SET_VOLTE_E911_SCAN_LIST Received Broadcast(change) "
    ...
    const-string v4, "com.lge.intent.action.VOLTE_E911_SCAN_LIST_COMPLETE"
    ...
    const-string v5, "CTC : Event EVENT_SET_LTE_ONLY_FOR_TDD"
    ...
    const-string v6, "CTC : ar.userObj is not Message type  ar.userObj = "
    ...
    invoke-direct {p0, v5}, Lcom/android/internal/telephony/PhoneBase;->getLteBand(I)J

    move-result-wide v5

    invoke-interface {v4, v5, v6, v2}, Lcom/android/internal/telephony/CommandsInterface;->setLteBandMode(JLandroid/os/Message;)V
...
.method public hangUpForVolte(Z)Z
    ...
    const-string v1, "Error! hangUpForVolte() in PhoneBase should not be called."
...
.method public notifyDataConnection(Ljava/lang/String;Ljava/lang/String;Lcom/android/internal/telephony/dataconnection/DcFailCause;)V
    .locals 6
    .parameter "reason"
    .parameter "apnType"
    .parameter "cause"
    ...
    invoke-interface/range {v0 .. v5}, Lcom/android/internal/telephony/PhoneNotifier;->notifyDataConnection(Lcom/android/internal/telephony/Phone;Ljava/lang/String;Ljava/lang/String;Lcom/android/internal/telephony/PhoneConstants$DataState;Lcom/android/internal/telephony/dataconnection/DcFailCause;)V
...
.method public permanantAutomode(Landroid/os/Message;)V
    .locals 1
    .parameter "response"
...
.method public processECCNotiRep(Lcom/android/internal/telephony/MmiCode;)Z
    ...
    .prologue
    .line 1798
    const-string v0, "processECCNotiRep"
...
.method public processECCNotiUSSD(Ljava/lang/String;)V
    ...
    .prologue
    .line 1794
    const-string v0, "processECCNotiUSSD"
...
.method public setCdmaFactoryReset(Landroid/os/Message;)V
    ...
    .prologue
    .line 1936
    const-string v0, "setCdmaFactoryReset"
...
.method public setDebugInfoValue(ILandroid/os/Message;)V
    ...
    const-string v2, "PhoneBase setDebugInfoValue param = "
...
.method public setIMSRegistate(Z)V
    ...
    const-string v3, "setIMSRegistate - regiState : "
    ...
    .line 2036
    invoke-virtual {v0, p1}, Lcom/android/internal/telephony/ServiceStateTracker;->setIMSRegistate(Z)V

    .line 2039
    :cond_0
    iget-object v1, p0, Lcom/android/internal/telephony/PhoneBase;->mDcTracker:Lcom/android/internal/telephony/dataconnection/DcTrackerBase;

    invoke-virtual {v1, p1}, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->setIMSRegistate(Z)V
...
.method public setIsE911ForVolte(Z)V
    ...
    .line 1853
    iput-boolean p1, p0, Lcom/android/internal/telephony/PhoneBase;->mIsE911ForVolte:Z
...
.method public setMiMoAntennaControlTest(Landroid/os/Message;I)V
    ...
    invoke-virtual {p0, p1, v0, p2}, Lcom/android/internal/telephony/PhoneBase;->setMiMoAntennaControlTest(Landroid/os/Message;II)V
...
.method public setTddStatus(ILandroid/os/Message;)V
    ...
    invoke-virtual {p0, v9, v6, v5, p2}, Landroid/os/Handler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-virtual {p0, v9, v5, v5, p2}, Landroid/os/Handler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/PhoneBase;->getLteBand(I)J

    move-result-wide v3

    invoke-interface {v2, v3, v4, p2}, Lcom/android/internal/telephony/CommandsInterface;->setLteBandMode(JLandroid/os/Message;)V
