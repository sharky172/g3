...
.field private static final PDU_PENDING_MESSAGE_PROJECTION_STITCHING:[Ljava/lang/String; = null
...
.method private scanRawTable()V
    ...
    .line 124
    .local v21, multiPartReceivedCount:Ljava/util/HashMap;,"Ljava/util/HashMap<Lcom/android/internal/telephony/SmsBroadcastUndelivered$SmsReferenceKey;Ljava/lang/Integer;>;"
    ...
    .line 125
    .local v23, oldMultiPartMessages:Ljava/util/HashSet;,"Ljava/util/HashSet<Lcom/android/internal/telephony/SmsBroadcastUndelivered$SmsReferenceKey;>;"
    const/4 v10, 0x0
    ...
    .line 140
    .local v19, isCurrentFormat3gpp2:Z
    :cond_3
    :goto_2
    ...
    .line 143
    :try_start_2
    new-instance v31, Lcom/android/internal/telephony/InboundSmsTracker;
    ...
    .line 149
    .local v31, tracker:Lcom/android/internal/telephony/InboundSmsTracker;
    :try_start_3
    invoke-virtual/range {v31 .. v31}, Lcom/android/internal/telephony/InboundSmsTracker;->getMessageCount()I
    ...
    .line 228
    .end local v19           #isCurrentFormat3gpp2:Z
    .end local v31           #tracker:Lcom/android/internal/telephony/InboundSmsTracker;
    :catch_0
    move-exception v15
    ...
    .restart local v19       #isCurrentFormat3gpp2:Z
    :catch_1
    move-exception v15
    ...
    .line 153
    .restart local v19       #isCurrentFormat3gpp2:Z
    .restart local v31       #tracker:Lcom/android/internal/telephony/InboundSmsTracker;
    :cond_6
    :try_start_6
    new-instance v25, Lcom/android/internal/telephony/SmsBroadcastUndelivered$SmsReferenceKey;
    ...
    .line 154
    .local v25, reference:Lcom/android/internal/telephony/SmsBroadcastUndelivered$SmsReferenceKey;
    move-object/from16 v0, v21
    ...
    .line 155
    .local v24, receivedCount:Ljava/lang/Integer;
    if-nez v24, :cond_9
    ...
    .line 157
    invoke-virtual/range {v31 .. v31}, Lcom/android/internal/telephony/InboundSmsTracker;->getTimestamp()J
    ...
    const-wide/32 v29, 0x2932e00

    .line 179
    .local v29, stitchingWaitTime:J
    ...
    .end local v16           #firstTime:J
    .end local v29           #stitchingWaitTime:J
    :cond_9
    ...
    .end local v24           #receivedCount:Ljava/lang/Integer;
    .end local v25           #reference:Lcom/android/internal/telephony/SmsBroadcastUndelivered$SmsReferenceKey;
    .end local v31           #tracker:Lcom/android/internal/telephony/InboundSmsTracker;
    :cond_b
    ...
    check-cast v20, Lcom/android/internal/telephony/SmsBroadcastUndelivered$SmsReferenceKey;

    .line 219
    .local v20, message:Lcom/android/internal/telephony/SmsBroadcastUndelivered$SmsReferenceKey;
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/internal/telephony/SmsBroadcastUndelivered$SmsReferenceKey;->getDeleteWhereArgs()[Ljava/lang/String;
    ...
    .line 231
    .end local v20           #message:Lcom/android/internal/telephony/SmsBroadcastUndelivered$SmsReferenceKey;
