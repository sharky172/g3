...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/internal/telephony/IccSmsInterfaceManager$TdLteConfirmDialogListener;
    }
.end annotation
...
.field protected static final EVENT_CT_SET_TDD_STATUS:I = 0x84
...
.field private static final EVENT_SINGLE_LTE_PROMPT:I = 0x83
...
.field public static final SMS_FORMAT_CSIM:I = 0x2

.field public static final SMS_FORMAT_USIM:I = 0x1


# instance fields
.field private ltePromptDialog:Landroid/app/AlertDialog;
...
.method public constructor <init>(Lcom/android/internal/telephony/PhoneBase;)V
    ...
    .line 159
    iput-object v2, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mUiccController:Lcom/android/internal/telephony/uicc/UiccController;
    ...
    .line 167
    iput-object v2, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->ltePromptDialog:Landroid/app/AlertDialog;
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mUiccController:Lcom/android/internal/telephony/uicc/UiccController;
...
.method static synthetic access$200(Lcom/android/internal/telephony/IccSmsInterfaceManager;[BILjava/lang/Boolean;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$302(Lcom/android/internal/telephony/IccSmsInterfaceManager;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$600(Lcom/android/internal/telephony/IccSmsInterfaceManager;)V
    .locals 0
    .parameter "x0"

    .prologue
    .line 92
    invoke-direct {p0}, Lcom/android/internal/telephony/IccSmsInterfaceManager;->userPromptSingleTDLte()V

    return-void
.end method

.method static synthetic access$800(Lcom/android/internal/telephony/IccSmsInterfaceManager;)Landroid/app/AlertDialog;
    .locals 1
    .parameter "x0"

    .prologue
    .line 92
    iget-object v0, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->ltePromptDialog:Landroid/app/AlertDialog;

    return-object v0
.end method

.method static synthetic access$802(Lcom/android/internal/telephony/IccSmsInterfaceManager;Landroid/app/AlertDialog;)Landroid/app/AlertDialog;
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 92
    iput-object p1, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->ltePromptDialog:Landroid/app/AlertDialog;
...
.method private userPromptSingleTDLte()V
    .locals 4

    .prologue
    .line 340
    new-instance v0, Lcom/android/internal/telephony/IccSmsInterfaceManager$TdLteConfirmDialogListener;

    const/4 v2, 0x0

    invoke-direct {v0, p0, v2}, Lcom/android/internal/telephony/IccSmsInterfaceManager$TdLteConfirmDialogListener;-><init>(Lcom/android/internal/telephony/IccSmsInterfaceManager;Lcom/android/internal/telephony/IccSmsInterfaceManager$1;)V

    .line 342
    .local v0, listener:Lcom/android/internal/telephony/IccSmsInterfaceManager$TdLteConfirmDialogListener;
    ...
    iget-object v2, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->ltePromptDialog:Landroid/app/AlertDialog;
...
.method public getMaxEfSmsMultiMode(I)I
    ...
    iput v5, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->recordSize:I

    .line 2136
    iget-object v5, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mUiccController:Lcom/android/internal/telephony/uicc/UiccController;

    if-nez v5, :cond_0

    .line 2137
    const-string v5, "getMaxEfSmsMultiMode(), mUiccController is NULL"
    ...
    .line 2141
    :cond_0
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/IccSmsInterfaceManager;->getUiccCardApplication(I)Lcom/android/internal/telephony/uicc/UiccCardApplication;

    move-result-object v3

    .line 2143
    .local v3, mUiccApp:Lcom/android/internal/telephony/uicc/UiccCardApplication;
    if-eqz v3, :cond_1
    ...
    .line 2147
    const-string v5, "getMaxEfSmsMultiMode(), mUiccApp or iccFileHandler is NULL"
    ...
    invoke-virtual {v2, v5, v4}, Lcom/android/internal/telephony/uicc/IccFileHandler;->getEFLinearRecordSize(ILandroid/os/Message;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    const-string v6, "getMaxEfSmsMultiMode(), smsformat="
    ...
    .local v1, e:Ljava/lang/Exception;
    :try_start_3
    const-string v5, "getMaxEfSmsMultiMode(), getRecordsSize, interrupted while trying to load from the SIM"
...
.method protected getUiccCardApplication(I)Lcom/android/internal/telephony/uicc/UiccCardApplication;
    .locals 3
    .parameter "smsformat"
    ...
    .line 2117
    iget-object v0, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mUiccController:Lcom/android/internal/telephony/uicc/UiccController;
    ...
    invoke-virtual {v0, v2}, Lcom/android/internal/telephony/uicc/UiccController;->getUiccCardApplication(I)Lcom/android/internal/telephony/uicc/UiccCardApplication;
...
.method public insertDBForLGMessage(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    .local v1, token:J
    :try_start_0
    const-string v3, "insertDBForLGMessage()"
...
.method protected isTDDLteMode()Z
    .locals 7
    ...
    .line 420
    .local v0, isTddLteMode:Z
    iget-object v3, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mContext:Landroid/content/Context;

    const-string v4, "sms_block_on_tdlte_only"
    ...
    .end local v2           #tddLteOnlyMode:I
    :cond_0
    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "isTDDLteMode(), [RED] isTddLteMode = "
...
.method public sendData(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I[BLandroid/app/PendingIntent;Landroid/app/PendingIntent;)V
    ...
    .line 933
    :cond_0
    invoke-virtual {p0}, Lcom/android/internal/telephony/IccSmsInterfaceManager;->isTDDLteMode()Z
    ...
    invoke-direct {p0}, Lcom/android/internal/telephony/IccSmsInterfaceManager;->getAppLabel()Ljava/lang/CharSequence;
...
.method public sendMultipartText(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-virtual/range {v1 .. v8}, Lcom/android/internal/telephony/SMSDispatcher;->sendMultipartText(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;IZ)V
...
.method public sendMultipartTextLge(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/lang/String;IIIZ)V
    ...
    invoke-virtual/range {v1 .. v11}, Lcom/android/internal/telephony/SMSDispatcher;->sendMultipartTextLge(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/lang/String;IIIZ)V
...
.method public sendTextLge(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/app/PendingIntent;Landroid/app/PendingIntent;Ljava/lang/String;IIIZ)V
    ...
    invoke-virtual/range {v1 .. v11}, Lcom/android/internal/telephony/SMSDispatcher;->sendTextLge(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/app/PendingIntent;Landroid/app/PendingIntent;Ljava/lang/String;IIIZ)V
...
.method public updateMeidforDMAutoregi(I)Z
    .locals 5
    ...
    const-string v3, "yeon : updateMeidforDMAutoregi, nCmdType is "
    ...
    invoke-interface {v2, p1, v4, v1}, Lcom/android/internal/telephony/CommandsInterface;->UIMInternalRequestCmd(I[BLandroid/os/Message;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .local v0, e:Ljava/lang/InterruptedException;
    :try_start_3
    const-string v2, "interrupted while trying to updateMeidforDMAutoregi"
