...
.method public getOtherActiveSub(I)I
    ...
    const-string v6, "is other sub active = "
    ...
    const-string v6, "got other active sub  = "
    ...
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/ExtCallManager;->getState(I)Lcom/android/internal/telephony/PhoneConstants$State;
    ...
    const-string v6, "CTC : [getOtherActiveSub] defaultSubId="
    ...
    .line 418
    const-string v4, "ril.curr.call.sub"
    ...
    invoke-static {v4}, Lcom/android/internal/telephony/lgeautoprofiling/LgeAutoProfiling;->getEccListMerged(Ljava/lang/String;)Ljava/lang/String;
...
.method public setActiveSubscription(I)V
    ...
    .line 254
    const-string v0, "persist.radio.voice_active.sub"

    sget v1, Lcom/android/internal/telephony/ExtCallManager;->mActiveSub:I
...
.method public setAudioMode()V
    ...
    .line 309
    iget-object v8, p0, Lcom/android/internal/telephony/ExtCallManager;->mAudioManager:Landroid/media/AudioManager;

    if-nez v8, :cond_0

    .line 310
    const-string v8, "ExtCallManager"

    const-string v9, "setAudioMode: Audio Service is null!! "
    ...
    .line 315
    .local v3, mode:I
    sget-object v8, Lcom/android/internal/telephony/ExtCallManager$1;->$SwitchMap$com$android$internal$telephony$PhoneConstants$State:[I
    ...
    const-string v9, "requestAudioFocus on STREAM_RING"
    ...
    invoke-virtual {v8, v10, v10}, Landroid/media/AudioManager;->requestAudioFocusForCall(II)V
    ...
    const-string v9, "setAudioMode RINGING"
    ...
    invoke-virtual {v8, v12}, Landroid/media/AudioManager;->setMode(I)V
    ...
    const-string v9, "setAudioMode IN_CALL"
    ...
    invoke-virtual {v8, v10}, Landroid/media/AudioManager;->setMode(I)V
    ...
    invoke-virtual {v8, v11, v10}, Landroid/media/AudioManager;->requestAudioFocusForCall(II)V
    ...
    invoke-virtual {v8, v11}, Landroid/media/AudioManager;->setMode(I)V
    ...
    invoke-virtual {v8}, Landroid/media/AudioManager;->abandonAudioFocusForCall()V
    ...
    invoke-virtual {v8}, Lcom/lge/telephony/msim/LGMSimTelephonyManager;->getDefaultSubscription()I

    move-result v2

    .line 380
    .local v2, defaultSubId:I
    const-string v8, "ril.curr.call.sub"
    ...
    const-string v10, "CTC : [setAudioMode] defaultSubId = "
    ...
    invoke-static {v8}, Lcom/android/internal/telephony/lgeautoprofiling/LgeAutoProfiling;->getEccListMerged(Ljava/lang/String;)Ljava/lang/String;
