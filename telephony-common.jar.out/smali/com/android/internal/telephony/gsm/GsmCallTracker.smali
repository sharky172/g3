...
.method constructor <init>(Lcom/android/internal/telephony/gsm/GSMPhone;)V
    ...
    .line 117
    iput-boolean v2, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mDesiredMute:Z
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mAssistDialPhoneNumberUtils:Lcom/lge/telephony/LGAssistDialPhoneNumberUtils;
    ...
    invoke-static {v1, p0}, Lcom/android/internal/telephony/gsm/TmusCallStateBroadcaster;->prepare(Landroid/content/Context;Lcom/android/internal/telephony/gsm/GsmCallTracker;)V
...
.method declared-synchronized dial(Ljava/lang/String;ILcom/android/internal/telephony/UUSInfo;)Lcom/android/internal/telephony/Connection;
    ...
    .line 295
    iget-object v5, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mAssistDialPhoneNumberUtils:Lcom/lge/telephony/LGAssistDialPhoneNumberUtils;
    ...
    invoke-virtual {v5, p1, v6}, Lcom/lge/telephony/LGAssistDialPhoneNumberUtils;->getAssitedDialFinalNumberForGSM(Ljava/lang/String;Landroid/content/Context;)Ljava/lang/String;
...
.method dialForVolte(Ljava/lang/String;)Z
    ...
    .line 441
    const-string v3, "isInEmergencyCall set to true on dialForVolte()"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget-object v8, p0, Lcom/android/internal/telephony/CallTracker;->mLastRelevantPoll:Landroid/os/Message;

    if-ne p1, v8, :cond_0

    .line 1232
    iput-boolean v11, p0, Lcom/android/internal/telephony/CallTracker;->mNeedsPoll:Z
    ...
    instance-of v8, v3, Lcom/android/internal/telephony/CommandException;
    ...
    sget-object v9, Lcom/android/internal/telephony/CommandException$Error;->DIAL_MODIFIED_TO_DIAL:Lcom/android/internal/telephony/CommandException$Error;
    ...
    const-string v9, "VOICE_STK_CC_MODIFIED - send broadcast"
    ...
    const-string v8, "com.lge.android.intent.action.voice_stk_cc_modified"
    ...
    invoke-virtual {p0, v8}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->dialPendingCall(I)V
    ...
    .line 1330
    iget v8, p0, Lcom/android/internal/telephony/CallTracker;->mPendingOperations:I
    ...
    iget v8, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPollTimeoutCount:I
    ...
    const-string v9, ", mForegroundCall.getState()"
    ...
    const-string v9, ", mPendingOperations"

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget v9, p0, Lcom/android/internal/telephony/CallTracker;->mPendingOperations:I

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v8

    const-string v9, ", mPollTimeoutCount="
    ...
    .line 1333
    iput v13, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mIsDoubleCheckGetCurCall:I
    ...
    .line 1335
    iget-object v8, p0, Lcom/android/internal/telephony/CallTracker;->mCi:Lcom/android/internal/telephony/CommandsInterface;

    iget-object v9, p0, Lcom/android/internal/telephony/CallTracker;->mLastRelevantPoll:Landroid/os/Message;
    ...
    const-string v9, "EVENT_POLL_DIAL_HANGUP_DONE: mPollTimeoutCount="
    ...
    const-string v9, ", fgCall.getState()="
    ...
    iput v8, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPollTimeoutCount:I
    ...
    iget v9, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPollTimeout:I
    ...
    .line 1357
    iput-boolean v12, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPollTimeoutExpired:Z

    .line 1358
    iput v11, p0, Lcom/android/internal/telephony/CallTracker;->mPendingOperations:I
    ...
    .line 1361
    iput v11, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mPollTimeoutCount:I
...
.method protected declared-synchronized handlePollCalls(Landroid/os/AsyncResult;)V
    ...
    const-string v18, "support_srvcc"
    ...
    const-string v17, "ro.lge.supportvolte"
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/android/internal/telephony/gsm/GsmConnection;->initSrvccHandover()V

    .line 810
    iget-boolean v0, v7, Lcom/android/internal/telephony/DriverCall;->isSrvccConfConn:Z
    ...
    iput-boolean v0, v1, Lcom/android/internal/telephony/gsm/GsmConnection;->mIsSrvccConfConn:Z
    ...
    invoke-static {v0, v5, v7}, Lcom/android/internal/telephony/gsm/AttCallStateBroadcaster;->updateCiqConnectionState(Landroid/content/Context;Lcom/android/internal/telephony/gsm/GsmConnection;Lcom/android/internal/telephony/DriverCall;)V
    ...
    iput-object v0, v5, Lcom/android/internal/telephony/gsm/GsmConnection;->mCause:Lcom/android/internal/telephony/Connection$DisconnectCause;
...
.method public hangUpForVolte(Z)Z
    ...
    .prologue
    .line 1173
    iget-boolean v0, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mIsEcmTimerCanceled:Z
    ...
    invoke-direct {p0, v0}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->handleEcmTimer(I)V
